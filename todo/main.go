...
import (
	...
	"github.com/xeptore/to-do/todo/db"
	"github.com/xeptore/to-do/todo/todo"
)
...
func main() {
	...
	pb.RegisterTodoServiceServer(grpcSrv, todoService)
	...
	sub, err := nc.Subscribe("request", func(msg *nats.Msg) {
		resp := todoService.HandleMessage(ctx, msg)
